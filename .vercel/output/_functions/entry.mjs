...
var middlewareSecret = "46d9a594-cbbd-463c-b83c-1b3290097c3d";
//#endregion
...
var _page1 = () => import("./chunks/index_a4LAUpQf.mjs");
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "46d9a594-cbbd-463c-b83c-1b3290097c3d") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
